...
const costoDiarioPorEnfermedad = {
    1: 125,
    2: 116,
    3: 120,
    4: 132,
...
const tipoEnfermedad = paciente.enfermedadTipo;
const cantDias = paciente.diasInternacion;
const costoInternacion = costoDiarioPorEnfermedad[tipoEnfermedad] * cantDias;

console.log(`Costo de internación de ${paciente.nombre}: $${costoInternacion}`);